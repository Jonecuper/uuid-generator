...
if (!isset($_GET['namespace']) || !isset($_GET['name'])) {
    ...
    echo json_encode(['error' => 'Parameters "namespace" and "name" are required for UUIDv3']);
    exit;
}
...
// Генерируем UUID версии 3
$uuid3 = UUID::getV3($namespace, $name);
